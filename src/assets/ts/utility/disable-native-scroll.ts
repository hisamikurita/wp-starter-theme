...
const scrollEventAuto = () => {
	document.removeEventListener("wheel", preventEvent, { capture: false });
	document.removeEventListener("scroll", preventEvent, { capture: false });
	document.removeEventListener("touchmove", preventEvent, { capture: false });
	document.removeEventListener("keydown", preventEvent, { capture: false });
};
